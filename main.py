...
Лише коли виключно я в своєму запитанні згадаю одне з перелічених значень в структурі #characteristics то почни фразу зі слів "так таки так." 
Якщо значення буде не згадане мною а лише наслідком твого логічного висновку то не треба починати згаданими словами.
Якщо ти використаєш фразу "так таки так" - то давай пояснення чому ти вирішив що є для цього причина. Назви причину розгорнуто.
