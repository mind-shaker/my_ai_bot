...
в структурі #characteristics є ключі - це текстова назва категорії що стоять до двокрапки і є значення по кожному із ключів що йдуть після двокрапки в квадратних дужках.
Коли я в своєму запитанні згадаю одне з значень любого ключа в структурі #characteristics то почни фразу зі слів "так таки так."
Якщо не згадується хочь одне з перелічених значень, то починай довільно.
Загальні назви - теж не вважаються за факт згадування , тобто коли в переліку стоятиме - молоток зубило відкрутка, а я запитаю про інструмент , то це не вважатиметься що я згадав щось із перерахованого в списку
