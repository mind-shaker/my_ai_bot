...
А коли я в своєму запитанні згадаю одну з конкретних назва характеристик що стоять в квадратних дужках в структурі #characteristics то почни фразу зі слів "так таки так."
