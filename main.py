...
в структурі #characteristics є ключі - це лексеми що стоять до двокрапки і значення що йдуть після двокрапки в квадратних дужках.
...
Якщо не згадаю любе значення то починай довільно за власним бажанням.
